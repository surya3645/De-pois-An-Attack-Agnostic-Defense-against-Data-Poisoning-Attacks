...
softmax = mx.symbol.load('/content/drive/MyDrive/MAIN/Poisoning-attack-master-20220408T190337Z-001/Poisoning-attack-master/model/mymodel.json')
arg_arrays_load = mx.nd.load('/content/drive/MyDrive/MAIN/Poisoning-attack-master-20220408T190337Z-001/Poisoning-attack-master/model/mymodel_args')
dev = mx.gpu(0)
batch_size = 1
...
train_iter = mx.io.MNISTIter(
         image="/content/drive/MyDrive/MAIN/mnist_ubyte-20220408T190334Z-001/mnist_ubyte/train-images.idx3-ubyte",
        label="/content/drive/MyDrive/MAIN/mnist_ubyte-20220408T190334Z-001/mnist_ubyte/train-labels.idx1-ubyte",
        input_shape=input_shape,
        batch_size=batch_size,
        shuffle=False,
        flat=flat)
val_iter = mx.io.MNISTIter(
        image="/content/drive/MyDrive/MAIN/mnist_ubyte-20220408T190334Z-001/mnist_ubyte/t10k-images.idx3-ubyte",
        label="/content/drive/MyDrive/MAIN/mnist_ubyte-20220408T190334Z-001/mnist_ubyte/t10k-labels.idx1-ubyte",
        input_shape=input_shape,
        batch_size=batch_size,
        shuffle=True,
        flat=flat)
...
with mx.Context(dev):
    ...
    # define autoencoder
    de_out = mx.symbol.load('/content/drive/MyDrive/MAIN/Poisoning-attack-master-20220408T190337Z-001/Poisoning-attack-master/model/aemodel_2.json')
    ae_arg_arrays_load = mx.nd.load('/content/drive/MyDrive/MAIN/Poisoning-attack-master-20220408T190337Z-001/Poisoning-attack-master/model/ae_args_2')
